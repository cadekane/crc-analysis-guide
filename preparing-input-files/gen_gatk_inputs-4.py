...
def def_refs(conf_keys):
    ...
    raw_file_dir = conf_keys['raw_file_dir']
    ...
    if ref_version == "b37":
        ...
        ref_refs['pon'] = f"{raw_file_dir}/pon/{groupname}_pon.vcf" # had to edit this to ensure the correct path for the product of the directories could be managed
        ref_refs['pon_idx'] = f"{raw_file_dir}/pon/{groupname}_pon.vcf.idx" # also edited this
...
def gen_pon(conf_keys, input_df, ref_refs):
    ...
    pon_output_dir = f'{base_output_dir}/pon' # I edited this, so the pon and m2 input jsons would be put into separate folders in the cromwell_inputs directory
...
def gen_m2(conf_keys, input_df, ref_refs):
    ...
    for s in subject_ids:
        ...
        m2_input = {
            ...
            "Mutect2.funco_reference_version": "hg19", # for b37, have to write in hg19! 
